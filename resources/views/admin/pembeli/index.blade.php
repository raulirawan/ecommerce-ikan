...
@section('content')
    ...
    <section class="content-main">
        <div class="content-header">
            <div>
                <h2 class="content-title card-title">Halaman Pembeli </h2>
            </div>
        </div>
        <div class="card mb-4">
            <div class="card-body">
                <button data-toggle="modal" data-target="#modal-create" class="btn btn-md rounded font-sm">(+) Tambah Pembeli</button>
    ...
    <div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Form Tambah Data Pembeli</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="POST" action="{{ route('admin.pembeli.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="form-group mb-3">
                                <label for="exampleInputEmail1">Nama Pembeli</label>
                                <input type="text" class="form-control" value="{{ old('nama_pembeli') }}"
                                    name="nama_pembeli" placeholder="Masukan Nama" required>
                            </div>
                            <div class="form-group mb-3">
       ...
       <div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Foem Edit Data Pembeli</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="POST" id="form-edit" action="#" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-3">
                                <label for="exampleInputEmail1">Nama Pembeli</label>
                                <input type="text" class="form-control" value="{{ old('nama_pembeli') }}" id="nama_pembeli"
                                    name="nama_pembeli" placeholder="Masukan Nama" required>
                            </div>
                            <div class="form-group mb-3">
                                <label for="exampleInputEmail1">Email</label>
        ...
        <script>
            $(document).ready(function() {
                $(document).on('click', '#edit', function() {
                    var id = $(this).data('id');
                    var nama_pembeli = $(this).data('nama_pembeli');
                    var email = $(this).data('email');
                    var no_hp = $(this).data('no_hp');
                    $('#nama_pembeli').val(nama_pembeli);
                    $('#email').val(email);
                    $('#no_hp').val(no_hp);
                    $('#form-edit').attr('action','/admin/pembeli/update/' + id);
                });
            });
        </script>
        <script>
