    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.produk.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="row mb-2 photo-gallery">
                            ...
                            <div class="col-4">
                                ...
                                <a href="{{ route('admin.produk.delete.gambar',[$data->id, $key]) }}" class="btn btn-danger rounded btn-sm badge btn-block">Hapus</a>
                            </div>
                            @endforeach
                        </div>
                        @endif
